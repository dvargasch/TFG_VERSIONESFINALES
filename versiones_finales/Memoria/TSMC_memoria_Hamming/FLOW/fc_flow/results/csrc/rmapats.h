...
extern "C" {
#endif
void  rmaPropagate2_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate19_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate19_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate19_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate20_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate20_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate20_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate20_r_results_daidir (UB  * pcode);
void  rmaPropagate20_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate21_r_results_daidir (UB  * pcode);
void  rmaPropagate21_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate22_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate22_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate22_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate22_r_results_daidir (UB  * pcode);
void  rmaPropagate22_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate23_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate23_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate23_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate23_r_results_daidir (UB  * pcode);
void  rmaPropagate23_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate24_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate24_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate24_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate24_r_results_daidir (UB  * pcode);
void  rmaPropagate24_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate25_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate25_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate25_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate25_r_results_daidir (UB  * pcode);
void  rmaPropagate25_t0_results_daidir (UB  * pcode, UB  val);
void  rmaPropagate25_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate26_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate26_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate26_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate26_r_results_daidir (UB  * pcode);
void  rmaPropagate26_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate27_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate27_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate27_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate27_r_results_daidir (UB  * pcode);
void  rmaPropagate27_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate28_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate28_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate28_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate28_r_results_daidir (UB  * pcode);
void  rmaPropagate28_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate29_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate29_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate29_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate29_r_results_daidir (UB  * pcode);
void  rmaPropagate29_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate30_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate30_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate30_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate30_r_results_daidir (UB  * pcode);
void  rmaPropagate30_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate31_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate31_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate31_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate31_r_results_daidir (UB  * pcode);
void  rmaPropagate31_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate32_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate32_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate32_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate32_r_results_daidir (UB  * pcode);
void  rmaPropagate32_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate33_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate33_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate33_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate33_r_results_daidir (UB  * pcode);
void  rmaPropagate33_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate34_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate34_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate34_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate34_r_results_daidir (UB  * pcode);
void  rmaPropagate34_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate35_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate35_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate35_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate35_r_results_daidir (UB  * pcode);
void  rmaPropagate35_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate36_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate36_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate36_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate36_r_results_daidir (UB  * pcode);
void  rmaPropagate36_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate37_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate37_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate37_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate37_r_results_daidir (UB  * pcode);
void  rmaPropagate37_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate38_r_results_daidir (UB  * pcode);
void  rmaPropagate38_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate39_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate39_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate39_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate39_r_results_daidir (UB  * pcode);
void  rmaPropagate39_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate40_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate40_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate40_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate40_r_results_daidir (UB  * pcode);
void  rmaPropagate40_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate41_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate41_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate41_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate41_r_results_daidir (UB  * pcode);
void  rmaPropagate41_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate42_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate42_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate42_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate42_r_results_daidir (UB  * pcode);
void  rmaPropagate42_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate43_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate43_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate43_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate43_r_results_daidir (UB  * pcode);
void  rmaPropagate43_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate44_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate44_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate44_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate44_r_results_daidir (UB  * pcode);
void  rmaPropagate44_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate45_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate45_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate45_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate45_r_results_daidir (UB  * pcode);
void  rmaPropagate45_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate46_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate46_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate46_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate46_r_results_daidir (UB  * pcode);
void  rmaPropagate46_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate47_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate47_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate47_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate47_r_results_daidir (UB  * pcode);
void  rmaPropagate47_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate48_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate48_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate48_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate48_r_results_daidir (UB  * pcode);
void  rmaPropagate48_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate49_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate49_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate49_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate49_r_results_daidir (UB  * pcode);
void  rmaPropagate49_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate50_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate50_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate50_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate50_r_results_daidir (UB  * pcode);
void  rmaPropagate50_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate51_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate51_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate51_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate51_r_results_daidir (UB  * pcode);
void  rmaPropagate51_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate52_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate52_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate52_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate52_r_results_daidir (UB  * pcode);
void  rmaPropagate52_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate53_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate53_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate53_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate53_r_results_daidir (UB  * pcode);
void  rmaPropagate53_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate54_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate54_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate54_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate54_r_results_daidir (UB  * pcode);
void  rmaPropagate54_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate55_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate55_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate55_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate55_r_results_daidir (UB  * pcode);
void  rmaPropagate55_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate56_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate56_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate56_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate56_r_results_daidir (UB  * pcode);
void  rmaPropagate56_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate57_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate57_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate57_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate57_r_results_daidir (UB  * pcode);
void  rmaPropagate57_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate58_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate58_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate58_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate58_r_results_daidir (UB  * pcode);
void  rmaPropagate58_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate59_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate60_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate60_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate60_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate60_r_results_daidir (UB  * pcode);
void  rmaPropagate60_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate61_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate61_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate61_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate61_r_results_daidir (UB  * pcode);
void  rmaPropagate61_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate62_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate62_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate62_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate62_r_results_daidir (UB  * pcode);
void  rmaPropagate62_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate63_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate63_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate63_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate63_r_results_daidir (UB  * pcode);
void  rmaPropagate63_wn_results_daidir (UB  * pcode, scalar  val);
