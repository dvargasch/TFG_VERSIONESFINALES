...
extern "C" {
#endif
void  rmaPropagate0_p_results_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_results_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_results_3_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate0_r_results_3_daidir (UB  * pcode);
void  rmaPropagate0_wn_results_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_results_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_results_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_results_3_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate1_r_results_3_daidir (UB  * pcode);
void  rmaPropagate1_wn_results_3_daidir (UB  * pcode, scalar  val);
