...
extern "C" {
#endif
void  hs_0_M_0_21__results3_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_0__results3_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_1__results3_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_0_2__results3_daidir (UB  * pcode);
void  hs_0_M_0_11__results3_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_21__results3_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_0__results3_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_1__results3_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_1_2__results3_daidir (UB  * pcode);
void  hs_0_M_1_11__results3_daidir (UB  * pcode, scalar  val);
