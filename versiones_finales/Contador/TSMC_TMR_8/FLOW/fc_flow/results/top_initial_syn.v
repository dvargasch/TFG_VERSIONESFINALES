...
// Generated on 5/22/2025 at 17:30:38
...
OAI211D0HPBWP ctmi_216 ( .A1 ( ctmn_147 ) , .A2 ( q[3] ) , .B ( ctmn_148 ) , 
    .C ( ctmn_145 ) , .ZN ( ctmn_166 ) ) ;
SDFCNQD0HPBWP \q_reg[5] ( .D ( N2 ) , .SI ( 1'b0 ) , .SE ( 1'b0 ) , 
    .CP ( \counter_3/clk_clock_gate_q_reg ) , .CDN ( SEQMAP_NET_82 ) , 
    .Q ( q[5] ) ) ;
...
SDFCNQD0HPBWP \q_reg[0] ( .D ( N7 ) , .SI ( 1'b0 ) , .SE ( 1'b0 ) , 
    .CP ( \counter_3/clk_clock_gate_q_reg ) , .CDN ( SEQMAP_NET_82 ) , 
    .Q ( q[0] ) ) ;
AOI22D0HPBWP ctmi_190 ( .A1 ( ctmn_145 ) , .A2 ( ctmn_152 ) , .B1 ( fault ) , 
    .B2 ( ctmn_159 ) , .ZN ( N0 ) ) ;
AOI22D0HPBWP ctmi_224 ( .A1 ( ctmn_145 ) , .A2 ( q[0] ) , .B1 ( fault ) , 
    .B2 ( voted_q[0] ) , .ZN ( N7 ) ) ;
CKND2D0HPBWP ctmi_221 ( .A1 ( ctmn_170 ) , .A2 ( ctmn_171 ) , .ZN ( N6 ) ) ;
CKLNQD1HPBWP clock_gate_q_reg ( .CP ( clk ) , .E ( enable ) , 
    .Q ( \counter_3/clk_clock_gate_q_reg ) , .TE ( 1'b0 ) ) ;
AOI22D0HPBWP ctmi_218 ( .A1 ( ctmn_145 ) , .A2 ( ctmn_168 ) , .B1 ( fault ) , 
    .B2 ( ctmn_169 ) , .ZN ( N5 ) ) ;
CKND2D0HPBWP ctmi_215 ( .A1 ( ctmn_166 ) , .A2 ( ctmn_167 ) , .ZN ( N4 ) ) ;
AOI22D0HPBWP ctmi_212 ( .A1 ( ctmn_145 ) , .A2 ( ctmn_164 ) , .B1 ( fault ) , 
    .B2 ( ctmn_165 ) , .ZN ( N3 ) ) ;
CKND2D0HPBWP ctmi_209 ( .A1 ( ctmn_162 ) , .A2 ( ctmn_163 ) , .ZN ( N2 ) ) ;
OAI211D0HPBWP ctmi_222 ( .A1 ( q[1] ) , .A2 ( q[0] ) , .B ( ctmn_146 ) , 
    .C ( ctmn_145 ) , .ZN ( ctmn_170 ) ) ;
MAOI22D0HPBWP ctmi_219 ( .A1 ( q[2] ) , .A2 ( ctmn_146 ) , .B1 ( q[2] ) , 
    .B2 ( ctmn_146 ) , .ZN ( ctmn_168 ) ) ;
SDFCNQD0HPBWP \q_reg[7] ( .D ( N0 ) , .SI ( 1'b0 ) , .SE ( 1'b0 ) , 
    .CP ( \counter_3/clk_clock_gate_q_reg ) , .CDN ( SEQMAP_NET_82 ) , 
    .Q ( q[7] ) ) ;
MAOI22D0HPBWP ctmi_213 ( .A1 ( q[4] ) , .A2 ( ctmn_148 ) , .B1 ( q[4] ) , 
    .B2 ( ctmn_148 ) , .ZN ( ctmn_164 ) ) ;
OAI211D0HPBWP ctmi_210 ( .A1 ( ctmn_149 ) , .A2 ( q[5] ) , .B ( ctmn_150 ) , 
    .C ( ctmn_145 ) , .ZN ( ctmn_162 ) ) ;
OAI211D0HPBWP ctmi_211 ( .A1 ( ctmn_156 ) , .A2 ( voted_q[5] ) , 
    .B ( fault ) , .C ( ctmn_157 ) , .ZN ( ctmn_163 ) ) ;
MAOI22D0HPBWP ctmi_214 ( .A1 ( voted_q[4] ) , .A2 ( ctmn_155 ) , 
    .B1 ( voted_q[4] ) , .B2 ( ctmn_155 ) , .ZN ( ctmn_165 ) ) ;
OAI211D0HPBWP ctmi_217 ( .A1 ( ctmn_154 ) , .A2 ( voted_q[3] ) , 
    .B ( fault ) , .C ( ctmn_155 ) , .ZN ( ctmn_167 ) ) ;
MAOI22D0HPBWP ctmi_220 ( .A1 ( voted_q[2] ) , .A2 ( ctmn_153 ) , 
    .B1 ( voted_q[2] ) , .B2 ( ctmn_153 ) , .ZN ( ctmn_169 ) ) ;
OAI211D0HPBWP ctmi_223 ( .A1 ( voted_q[1] ) , .A2 ( voted_q[0] ) , 
    .B ( fault ) , .C ( ctmn_153 ) , .ZN ( ctmn_171 ) ) ;
AOI22D0HPBWP ctmi_206 ( .A1 ( ctmn_145 ) , .A2 ( ctmn_160 ) , .B1 ( fault ) , 
    .B2 ( ctmn_161 ) , .ZN ( N1 ) ) ;
MAOI22D0HPBWP ctmi_207 ( .A1 ( q[6] ) , .A2 ( ctmn_150 ) , .B1 ( q[6] ) , 
    .B2 ( ctmn_150 ) , .ZN ( ctmn_160 ) ) ;
MAOI22D0HPBWP ctmi_208 ( .A1 ( voted_q[6] ) , .A2 ( ctmn_157 ) , 
    .B1 ( voted_q[6] ) , .B2 ( ctmn_157 ) , .ZN ( ctmn_161 ) ) ;
CKND0HPBWP ctmi_189 ( .I ( rst ) , .ZN ( SEQMAP_NET_82 ) ) ;
CKND0HPBWP ctmi_191 ( .I ( fault ) , .ZN ( ctmn_145 ) ) ;
MAOI22D0HPBWP ctmi_192 ( .A1 ( ctmn_151 ) , .A2 ( q[7] ) , .B1 ( ctmn_151 ) , 
    .B2 ( q[7] ) , .ZN ( ctmn_152 ) ) ;
IND2D0HPBWP ctmi_193 ( .A1 ( ctmn_150 ) , .B1 ( q[6] ) , .ZN ( ctmn_151 ) ) ;
CKND2D0HPBWP ctmi_194 ( .A1 ( ctmn_149 ) , .A2 ( q[5] ) , .ZN ( ctmn_150 ) ) ;
INR2D0HPBWP ctmi_195 ( .A1 ( q[4] ) , .B1 ( ctmn_148 ) , .ZN ( ctmn_149 ) ) ;
CKND2D0HPBWP ctmi_196 ( .A1 ( ctmn_147 ) , .A2 ( q[3] ) , .ZN ( ctmn_148 ) ) ;
INR2D0HPBWP ctmi_197 ( .A1 ( q[2] ) , .B1 ( ctmn_146 ) , .ZN ( ctmn_147 ) ) ;
CKND2D0HPBWP ctmi_198 ( .A1 ( q[0] ) , .A2 ( q[1] ) , .ZN ( ctmn_146 ) ) ;
MAOI22D0HPBWP ctmi_199 ( .A1 ( ctmn_158 ) , .A2 ( voted_q[7] ) , 
    .B1 ( ctmn_158 ) , .B2 ( voted_q[7] ) , .ZN ( ctmn_159 ) ) ;
IND2D0HPBWP ctmi_200 ( .A1 ( ctmn_157 ) , .B1 ( voted_q[6] ) , 
    .ZN ( ctmn_158 ) ) ;
CKND2D0HPBWP ctmi_201 ( .A1 ( ctmn_156 ) , .A2 ( voted_q[5] ) , 
    .ZN ( ctmn_157 ) ) ;
INR2D0HPBWP ctmi_202 ( .A1 ( voted_q[4] ) , .B1 ( ctmn_155 ) , 
    .ZN ( ctmn_156 ) ) ;
CKND2D0HPBWP ctmi_203 ( .A1 ( ctmn_154 ) , .A2 ( voted_q[3] ) , 
    .ZN ( ctmn_155 ) ) ;
INR2D0HPBWP ctmi_204 ( .A1 ( voted_q[2] ) , .B1 ( ctmn_153 ) , 
    .ZN ( ctmn_154 ) ) ;
CKND2D0HPBWP ctmi_205 ( .A1 ( voted_q[0] ) , .A2 ( voted_q[1] ) , 
    .ZN ( ctmn_153 ) ) ;
