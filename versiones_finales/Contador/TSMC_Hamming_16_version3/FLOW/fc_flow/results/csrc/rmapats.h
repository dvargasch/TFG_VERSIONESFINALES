...
extern "C" {
#endif
void  rmaPropagate11_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate11_r_results_daidir (UB  * pcode);
void  rmaPropagate11_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate12_r_results_daidir (UB  * pcode);
void  rmaPropagate12_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate13_r_results_daidir (UB  * pcode);
void  rmaPropagate13_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate14_r_results_daidir (UB  * pcode);
void  rmaPropagate14_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate15_r_results_daidir (UB  * pcode);
void  rmaPropagate15_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate16_r_results_daidir (UB  * pcode);
void  rmaPropagate16_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate17_r_results_daidir (UB  * pcode);
void  rmaPropagate17_wn_results_daidir (UB  * pcode, scalar  val);
...
void  rmaPropagate19_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate19_r_results_daidir (UB  * pcode);
void  rmaPropagate19_t0_results_daidir (UB  * pcode, UB  val);
