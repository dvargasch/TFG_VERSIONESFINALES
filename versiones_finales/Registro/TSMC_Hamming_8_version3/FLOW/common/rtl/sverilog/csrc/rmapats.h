...
extern "C" {
#endif
void  hs_0_M_0_21__prueba_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_0__prueba_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_1__prueba_2_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_0_2__prueba_2_daidir (UB  * pcode);
void  hs_0_M_0_11__prueba_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_21__prueba_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_0__prueba_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_1__prueba_2_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_1_2__prueba_2_daidir (UB  * pcode);
void  hs_0_M_1_11__prueba_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_21__prueba_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_0__prueba_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_1__prueba_2_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_2_2__prueba_2_daidir (UB  * pcode);
void  hs_0_M_2_11__prueba_2_daidir (UB  * pcode, scalar  val);
