...
extern "C" {
#endif
void  rmaPropagate0_p_prueba_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_prueba_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_prueba_3_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate0_r_prueba_3_daidir (UB  * pcode);
void  rmaPropagate0_wn_prueba_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_prueba_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_prueba_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_prueba_3_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate1_r_prueba_3_daidir (UB  * pcode);
void  rmaPropagate1_wn_prueba_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_p_prueba_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_prueba_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_f_prueba_3_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate2_r_prueba_3_daidir (UB  * pcode);
void  rmaPropagate2_wn_prueba_3_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_prueba_3_daidir (UB  * pcode, scalar  val);
