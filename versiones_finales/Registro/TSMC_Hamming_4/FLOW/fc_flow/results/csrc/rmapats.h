...
extern "C" {
#endif
void  rmaPropagate0_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate0_r_results_daidir (UB  * pcode);
void  rmaPropagate0_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate1_r_results_daidir (UB  * pcode);
void  rmaPropagate1_wn_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_p_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_results_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate2_r_results_daidir (UB  * pcode);
...
void  rmaPropagate3_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate3_r_results_daidir (UB  * pcode);
...
void  rmaPropagate4_f_results_daidir (UB  * pcode, scalar  val, U  I614, scalar  * I1420, U  did);
void  rmaPropagate4_r_results_daidir (UB  * pcode);
