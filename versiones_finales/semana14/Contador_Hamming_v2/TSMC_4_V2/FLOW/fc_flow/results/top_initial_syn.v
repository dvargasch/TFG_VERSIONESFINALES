...
// Generated on 6/5/2025 at 10:49:40
...
AOI21D0HPBWP ctmi_93 ( .A1 ( ctmn_73 ) , .A2 ( ctmn_82 ) , .B ( enable ) , 
    .ZN ( N24 ) ) ;
NR2D0HPBWP ctmi_81 ( .A1 ( ctmn_69 ) , .A2 ( ctmn_77 ) , .ZN ( N15 ) ) ;
NR2D0HPBWP ctmi_87 ( .A1 ( ctmn_69 ) , .A2 ( ctmn_79 ) , .ZN ( N16 ) ) ;
NR2D0HPBWP ctmi_90 ( .A1 ( ctmn_69 ) , .A2 ( ctmn_81 ) , .ZN ( N17 ) ) ;
NR2D0HPBWP ctmi_94 ( .A1 ( syndrome[1] ) , .A2 ( syndrome[0] ) , 
    .ZN ( ctmn_82 ) ) ;
CKND0HPBWP ctmi_95 ( .I ( rst ) , .ZN ( SEQMAP_NET_4 ) ) ;
MAOI22D0HPBWP ctmi_96 ( .A1 ( parity_stored[0] ) , .A2 ( ctmn_83 ) , 
    .B1 ( parity_stored[0] ) , .B2 ( ctmn_83 ) , .ZN ( N27 ) ) ;
NR2D0HPBWP ctmi_97 ( .A1 ( ctmn_75 ) , .A2 ( syndrome[2] ) , .ZN ( ctmn_83 ) ) ;
MOAI22D0HPBWP ctmi_82 ( .A1 ( counter_reg[2] ) , .A2 ( ctmn_76 ) , 
    .B1 ( counter_reg[2] ) , .B2 ( ctmn_76 ) , .ZN ( ctmn_77 ) ) ;
NR2D0HPBWP ctmi_83 ( .A1 ( ctmn_73 ) , .A2 ( ctmn_75 ) , .ZN ( ctmn_76 ) ) ;
MAOI22D0HPBWP ctmi_98 ( .A1 ( parity_stored[1] ) , .A2 ( ctmn_84 ) , 
    .B1 ( parity_stored[1] ) , .B2 ( ctmn_84 ) , .ZN ( N26 ) ) ;
SDFCNQD0HPBWP \corrected_counter_reg[2] ( .D ( N15 ) , .SI ( 1'b0 ) , 
    .SE ( 1'b0 ) , .CP ( clk ) , .CDN ( SEQMAP_NET_4 ) , 
    .Q ( corrected_counter[2] ) ) ;
SDFCNQD0HPBWP \corrected_counter_reg[1] ( .D ( N16 ) , .SI ( 1'b0 ) , 
    .SE ( 1'b0 ) , .CP ( clk ) , .CDN ( SEQMAP_NET_4 ) , 
    .Q ( corrected_counter[1] ) ) ;
SDFCNQD0HPBWP \corrected_counter_reg[0] ( .D ( N17 ) , .SI ( 1'b0 ) , 
    .SE ( 1'b0 ) , .CP ( clk ) , .CDN ( SEQMAP_NET_4 ) , 
    .Q ( corrected_counter[0] ) ) ;
SDFCNQD0HPBWP \corrected_parity_reg[2] ( .D ( N25 ) , .SI ( 1'b0 ) , 
    .SE ( 1'b0 ) , 
    .CP ( \syndrome_inst/clk_clock_gate_corrected_parity_reg ) , 
    .CDN ( SEQMAP_NET_4 ) , .Q ( corrected_parity[2] ) ) ;
SDFCNQD0HPBWP \corrected_parity_reg[1] ( .D ( N26 ) , .SI ( 1'b0 ) , 
    .SE ( 1'b0 ) , 
    .CP ( \syndrome_inst/clk_clock_gate_corrected_parity_reg ) , 
    .CDN ( SEQMAP_NET_4 ) , .Q ( corrected_parity[1] ) ) ;
SDFCNQD0HPBWP \corrected_parity_reg[0] ( .D ( N27 ) , .SI ( 1'b0 ) , 
    .SE ( 1'b0 ) , 
    .CP ( \syndrome_inst/clk_clock_gate_corrected_parity_reg ) , 
    .CDN ( SEQMAP_NET_4 ) , .Q ( corrected_parity[0] ) ) ;
MOAI22D0HPBWP ctmi_88 ( .A1 ( counter_reg[1] ) , .A2 ( ctmn_78 ) , 
    .B1 ( counter_reg[1] ) , .B2 ( ctmn_78 ) , .ZN ( ctmn_79 ) ) ;
NR3D0HPBWP ctmi_89 ( .A1 ( ctmn_73 ) , .A2 ( ctmn_74 ) , .A3 ( syndrome[0] ) , 
    .ZN ( ctmn_78 ) ) ;
MAOI22D0HPBWP ctmi_100 ( .A1 ( parity_stored[2] ) , .A2 ( ctmn_82 ) , 
    .B1 ( parity_stored[2] ) , .B2 ( ctmn_82 ) , .ZN ( N25 ) ) ;
MOAI22D0HPBWP ctmi_91 ( .A1 ( counter_reg[0] ) , .A2 ( ctmn_80 ) , 
    .B1 ( counter_reg[0] ) , .B2 ( ctmn_80 ) , .ZN ( ctmn_81 ) ) ;
NR2D0HPBWP ctmi_92 ( .A1 ( ctmn_73 ) , .A2 ( ctmn_70 ) , .ZN ( ctmn_80 ) ) ;
NR3D0HPBWP ctmi_99 ( .A1 ( ctmn_74 ) , .A2 ( syndrome[2] ) , 
    .A3 ( syndrome[0] ) , .ZN ( ctmn_84 ) ) ;
NR2D0HPBWP ctmi_72 ( .A1 ( enable_last ) , .A2 ( ctmn_67 ) , 
    .ZN ( syndrome[1] ) ) ;
NR2D0HPBWP ctmi_76 ( .A1 ( ctmn_69 ) , .A2 ( ctmn_72 ) , .ZN ( N14 ) ) ;
NR2D0HPBWP ctmi_74 ( .A1 ( enable_last ) , .A2 ( ctmn_68 ) , 
    .ZN ( syndrome[0] ) ) ;
IND2D0HPBWP ctmi_77 ( .A1 ( enable ) , .B1 ( error_detected ) , 
    .ZN ( ctmn_69 ) ) ;
XNR4D0HPBWP ctmi_73 ( .A1 ( counter_reg[3] ) , .A2 ( counter_reg[0] ) , 
    .A3 ( counter_reg[1] ) , .A4 ( parity_stored[1] ) , .ZN ( ctmn_67 ) ) ;
XNR3D0HPBWP ctmi_75 ( .A1 ( ctmn_65 ) , .A2 ( counter_reg[3] ) , 
    .A3 ( parity_stored[0] ) , .ZN ( ctmn_68 ) ) ;
MOAI22D0HPBWP ctmi_78 ( .A1 ( counter_reg[3] ) , .A2 ( ctmn_71 ) , 
    .B1 ( counter_reg[3] ) , .B2 ( ctmn_71 ) , .ZN ( ctmn_72 ) ) ;
NR2D0HPBWP ctmi_79 ( .A1 ( ctmn_70 ) , .A2 ( syndrome[2] ) , .ZN ( ctmn_71 ) ) ;
CKND2D0HPBWP ctmi_80 ( .A1 ( syndrome[1] ) , .A2 ( syndrome[0] ) , 
    .ZN ( ctmn_70 ) ) ;
CKND0HPBWP ctmi_84 ( .I ( syndrome[2] ) , .ZN ( ctmn_73 ) ) ;
CKND2D0HPBWP ctmi_85 ( .A1 ( syndrome[0] ) , .A2 ( ctmn_74 ) , 
    .ZN ( ctmn_75 ) ) ;
CKND0HPBWP ctmi_86 ( .I ( syndrome[1] ) , .ZN ( ctmn_74 ) ) ;
NR2D0HPBWP ctmi_69 ( .A1 ( enable_last ) , .A2 ( ctmn_66 ) , 
    .ZN ( syndrome[2] ) ) ;
XNR3D0HPBWP ctmi_70 ( .A1 ( ctmn_65 ) , .A2 ( parity_stored[2] ) , 
    .A3 ( counter_reg[1] ) , .ZN ( ctmn_66 ) ) ;
MAOI22D0HPBWP ctmi_71 ( .A1 ( counter_reg[0] ) , .A2 ( counter_reg[2] ) , 
    .B1 ( counter_reg[0] ) , .B2 ( counter_reg[2] ) , .ZN ( ctmn_65 ) ) ;
SDFCNQD0HPBWP \corrected_counter_reg[3] ( .D ( N14 ) , .SI ( 1'b0 ) , 
    .SE ( 1'b0 ) , .CP ( clk ) , .CDN ( SEQMAP_NET_4 ) , 
    .Q ( corrected_counter[3] ) ) ;
CKLNQD1HPBWP clock_gate_corrected_parity_reg ( .CP ( clk ) , .E ( N24 ) , 
