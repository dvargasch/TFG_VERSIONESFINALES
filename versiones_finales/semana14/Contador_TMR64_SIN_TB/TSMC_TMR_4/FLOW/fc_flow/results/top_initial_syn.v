...
// Generated on 6/9/2025 at 17:42:11
...
CKND0HPBWP ctmi_84 ( .I ( ctmn_58 ) , .ZN ( ctmn_59 ) ) ;
...
SDFCNQD0HPBWP \q_reg[0] ( .D ( N3 ) , .SI ( 1'b0 ) , .SE ( 1'b0 ) , 
    .CP ( \counter_3/clk_clock_gate_q_reg ) , .CDN ( SEQMAP_NET_26 ) , 
    .Q ( q[0] ) ) ;
AOI22D0HPBWP ctmi_77 ( .A1 ( ctmn_49 ) , .A2 ( ctmn_55 ) , .B1 ( fault ) , 
    .B2 ( ctmn_57 ) , .ZN ( N1 ) ) ;
MOAI22D0HPBWP ctmi_78 ( .A1 ( ctmn_54 ) , .A2 ( q[2] ) , .B1 ( ctmn_54 ) , 
    .B2 ( q[2] ) , .ZN ( ctmn_55 ) ) ;
CKLNQD1HPBWP clock_gate_q_reg ( .CP ( clk ) , .E ( enable ) , 
    .Q ( \counter_3/clk_clock_gate_q_reg ) , .TE ( 1'b0 ) ) ;
CKND0HPBWP ctmi_79 ( .I ( ctmn_50 ) , .ZN ( ctmn_54 ) ) ;
MOAI22D0HPBWP ctmi_80 ( .A1 ( ctmn_56 ) , .A2 ( voted_q[2] ) , 
    .B1 ( ctmn_56 ) , .B2 ( voted_q[2] ) , .ZN ( ctmn_57 ) ) ;
MUX3ND0HPBWP ctmi_82 ( .I0 ( ctmn_58 ) , .I1 ( ctmn_59 ) , .I2 ( ctmn_61 ) , 
    .S0 ( voted_q[3] ) , .S1 ( ctmn_49 ) , .ZN ( N0 ) ) ;
CKND2D0HPBWP ctmi_83 ( .A1 ( ctmn_56 ) , .A2 ( voted_q[2] ) , 
    .ZN ( ctmn_58 ) ) ;
SDFCNQD0HPBWP \q_reg[3] ( .D ( N0 ) , .SI ( 1'b0 ) , .SE ( 1'b0 ) , 
    .CP ( \counter_3/clk_clock_gate_q_reg ) , .CDN ( SEQMAP_NET_26 ) , 
    .Q ( q[3] ) ) ;
MAOI22D0HPBWP ctmi_85 ( .A1 ( ctmn_60 ) , .A2 ( q[3] ) , .B1 ( ctmn_60 ) , 
    .B2 ( q[3] ) , .ZN ( ctmn_61 ) ) ;
AOI22D0HPBWP ctmi_70 ( .A1 ( ctmn_49 ) , .A2 ( q[0] ) , .B1 ( fault ) , 
    .B2 ( voted_q[0] ) , .ZN ( N3 ) ) ;
CKND2D0HPBWP ctmi_72 ( .A1 ( ctmn_51 ) , .A2 ( ctmn_53 ) , .ZN ( N2 ) ) ;
CKND0HPBWP ctmi_81 ( .I ( ctmn_52 ) , .ZN ( ctmn_56 ) ) ;
CKND2D0HPBWP ctmi_86 ( .A1 ( ctmn_54 ) , .A2 ( q[2] ) , .ZN ( ctmn_60 ) ) ;
CKND0HPBWP ctmi_69 ( .I ( rst ) , .ZN ( SEQMAP_NET_26 ) ) ;
CKND0HPBWP ctmi_71 ( .I ( fault ) , .ZN ( ctmn_49 ) ) ;
OAI211D0HPBWP ctmi_73 ( .A1 ( q[0] ) , .A2 ( q[1] ) , .B ( ctmn_50 ) , 
    .C ( ctmn_49 ) , .ZN ( ctmn_51 ) ) ;
CKND2D0HPBWP ctmi_74 ( .A1 ( q[0] ) , .A2 ( q[1] ) , .ZN ( ctmn_50 ) ) ;
OAI211D0HPBWP ctmi_75 ( .A1 ( voted_q[0] ) , .A2 ( voted_q[1] ) , 
    .B ( fault ) , .C ( ctmn_52 ) , .ZN ( ctmn_53 ) ) ;
CKND2D0HPBWP ctmi_76 ( .A1 ( voted_q[0] ) , .A2 ( voted_q[1] ) , 
    .ZN ( ctmn_52 ) ) ;
