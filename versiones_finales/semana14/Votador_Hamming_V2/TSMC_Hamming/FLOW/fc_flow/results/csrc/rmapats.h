...
void  hs_0_M_3_21__results_daidir (UB  * pcode, scalar  val);
void  hs_0_M_3_0__results_daidir (UB  * pcode, scalar  val);
void  hs_0_M_3_11__results_daidir (UB  * pcode, scalar  val);
void  hs_0_M_8_21__results_daidir (UB  * pcode, scalar  val);
void  hs_0_M_8_0__results_daidir (UB  * pcode, scalar  val);
void  hs_0_M_8_1__results_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_8_2__results_daidir (UB  * pcode);
void  hs_0_M_8_11__results_daidir (UB  * pcode, scalar  val);
void  hs_0_M_9_21__results_daidir (UB  * pcode, scalar  val);
void  hs_0_M_9_0__results_daidir (UB  * pcode, scalar  val);
void  hs_0_M_9_1__results_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_9_2__results_daidir (UB  * pcode);
void  hs_0_M_9_11__results_daidir (UB  * pcode, scalar  val);
