################################################################################
#
# Created by fc write_floorplan on Sun May 25 22:36:24 2025
#
################################################################################
...
create_site_array -name unit_row -site unit -default -boundary { {10.0000 \
    10.0000} {26.2000 20.0000} } -flip_first_row true -flip_alternate_row true \
...
set track [create_track -layer M1 -count 151 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M1 -count 182 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M2 -count 151 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M2 -count 182 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M3 -count 151 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M3 -count 182 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M4 -count 151 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M4 -count 182 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M5 -count 151 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M5 -count 182 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M6 -count 151 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M6 -count 182 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M7 -count 151 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M7 -count 182 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {36.2000 30.0000 }}]
set track [create_track -layer M8 -count 38 -dir Y -space 0.8000 -coord 0.4000 \
    -bbox {{0.0000 0.4000 } {36.2000 30.0000 }}]
set track [create_track -layer M8 -count 45 -dir X -space 0.8000 -coord 0.4000 \
    -bbox {{0.4000 0.0000 } {35.6000 30.0000 }}]
set track [create_track -layer M9 -count 38 -dir Y -space 0.8000 -coord 0.4000 \
    -bbox {{0.0000 0.4000 } {36.2000 30.0000 }}]
set track [create_track -layer M9 -count 45 -dir X -space 0.8000 -coord 0.4000 \
    -bbox {{0.4000 0.0000 } {35.6000 30.0000 }}]
set track [create_track -layer AP -count 5 -dir Y -space 6.5000 -coord 3.5000 \
    -bbox {{0.0000 3.5000 } {36.2000 29.5000 }}]
set track [create_track -layer AP -count 6 -dir X -space 6.5000 -coord 3.5000 \
    -bbox {{3.5000 0.0000 } {36.0000 30.0000 }}]
