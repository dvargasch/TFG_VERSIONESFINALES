################################################################################
#
# Created by fc write_floorplan on Sun May 25 01:36:21 2025
#
################################################################################
...
create_site_array -name unit_row -site unit -default -boundary { {10.0000 \
    10.0000} {112.8000 78.0000} } -flip_first_row true -flip_alternate_row true \
...
set track [create_track -layer M1 -count 441 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M1 -count 615 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M2 -count 441 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M2 -count 615 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M3 -count 441 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M3 -count 615 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M4 -count 441 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M4 -count 615 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M5 -count 441 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M5 -count 615 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M6 -count 441 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M6 -count 615 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M7 -count 441 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M7 -count 615 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M8 -count 110 -dir Y -space 0.8000 -coord 0.4000 \
    -bbox {{0.0000 0.4000 } {122.8000 87.6000 }}]
set track [create_track -layer M8 -count 154 -dir X -space 0.8000 -coord 0.4000 \
    -bbox {{0.4000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer M9 -count 110 -dir Y -space 0.8000 -coord 0.4000 \
    -bbox {{0.0000 0.4000 } {122.8000 87.6000 }}]
set track [create_track -layer M9 -count 154 -dir X -space 0.8000 -coord 0.4000 \
    -bbox {{0.4000 0.0000 } {122.8000 88.0000 }}]
set track [create_track -layer AP -count 14 -dir Y -space 6.5000 -coord 3.5000 \
    -bbox {{0.0000 3.5000 } {122.8000 88.0000 }}]
set track [create_track -layer AP -count 19 -dir X -space 6.5000 -coord 3.5000 \
    -bbox {{3.5000 0.0000 } {120.5000 88.0000 }}]
