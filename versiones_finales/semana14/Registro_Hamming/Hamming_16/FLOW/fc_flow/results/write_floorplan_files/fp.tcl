################################################################################
#
# Created by fc write_floorplan on Sun May 25 01:02:14 2025
#
################################################################################
...
create_site_array -name unit_row -site unit -default -boundary { {10.0000 \
    10.0000} {62.0000 44.0000} } -flip_first_row true -flip_alternate_row true \
...
set track [create_track -layer M1 -count 271 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M1 -count 361 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M2 -count 271 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M2 -count 361 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M3 -count 271 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M3 -count 361 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M4 -count 271 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M4 -count 361 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M5 -count 271 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M5 -count 361 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M6 -count 271 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M6 -count 361 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M7 -count 271 -dir Y -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M7 -count 361 -dir X -space 0.2000 -coord 0.0000 \
    -bbox {{0.0000 0.0000 } {72.0000 54.0000 }}]
set track [create_track -layer M8 -count 68 -dir Y -space 0.8000 -coord 0.4000 \
    -bbox {{0.0000 0.4000 } {72.0000 54.0000 }}]
set track [create_track -layer M8 -count 90 -dir X -space 0.8000 -coord 0.4000 \
    -bbox {{0.4000 0.0000 } {71.6000 54.0000 }}]
set track [create_track -layer M9 -count 68 -dir Y -space 0.8000 -coord 0.4000 \
    -bbox {{0.0000 0.4000 } {72.0000 54.0000 }}]
set track [create_track -layer M9 -count 90 -dir X -space 0.8000 -coord 0.4000 \
    -bbox {{0.4000 0.0000 } {71.6000 54.0000 }}]
set track [create_track -layer AP -count 8 -dir Y -space 6.5000 -coord 3.5000 \
    -bbox {{0.0000 3.5000 } {72.0000 49.0000 }}]
set track [create_track -layer AP -count 11 -dir X -space 6.5000 -coord 3.5000 \
    -bbox {{3.5000 0.0000 } {68.5000 54.0000 }}]
