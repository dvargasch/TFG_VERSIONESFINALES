...
extern "C" {
#endif
void  hs_0_M_0_21__sin_errores_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_0__sin_errores_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_1__sin_errores_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_0_2__sin_errores_daidir (UB  * pcode);
void  hs_0_M_0_11__sin_errores_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_21__sin_errores_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_0__sin_errores_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_1__sin_errores_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_1_2__sin_errores_daidir (UB  * pcode);
void  hs_0_M_1_11__sin_errores_daidir (UB  * pcode, scalar  val);
