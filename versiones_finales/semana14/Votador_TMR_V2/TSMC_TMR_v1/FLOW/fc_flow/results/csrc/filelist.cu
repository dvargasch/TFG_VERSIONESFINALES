...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _592432_archive_1.so
_592432_archive_1.so : archive.1/_592432_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../results.daidir//_592432_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../results.daidir//_592432_archive_1.so $@
