...
void  hs_0_M_4_21__results_daidir (UB  * pcode, scalar  val);
void  hs_0_M_4_0__results_daidir (UB  * pcode, scalar  val);
void  hs_0_M_4_11__results_daidir (UB  * pcode, scalar  val);
void  hs_0_M_7_0__results_daidir (UB  * pcode, scalar  val);
